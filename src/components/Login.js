  ...
  return (
    <div>
      ...
      <form className="w-3/12 absolute p-12 bg-black my-36 mx-auto left-0 right-0 text-white rounded-lg bg-opacity-80">
        ...
        {!isSignInForm && <input type="text" placeholder="Full Name" className="p-4 my-4 w-full bg-black border border-gray-700 rounded-lg"/>}
        <input type="text" placeholder="Email Address" className="p-4 my-4 w-full bg-black border border-gray-700 rounded-lg"/>
        <input type="password" placeholder="Password" className="p-4 my-4 w-full bg-black border border-gray-700 rounded-lg"/>
